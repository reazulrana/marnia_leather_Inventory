<header class="main-header" id="header">
   ...
   <!-- Cart Section -->
   <li class="custom-dropdown">
    <a class="active custom-dropdown-toggler"  href="javascript:" >
      ...
      <span class="badge badge-xs rounded-circle">21</span>
          ...
          <li class="dropdown user-menu">
            <button class="dropdown-toggle nav-link" data-toggle="dropdown">
              <img src="bootstap_template/theme/images/user/user-xs-01.jpg" class="user-image rounded-circle" alt="User Image" />
              <span class="d-none d-lg-inline-block">{{ Auth::user()->email }}</span>
              <span class="d-none d-lg-inline-block">{{ Auth::user()->id }}</span>
